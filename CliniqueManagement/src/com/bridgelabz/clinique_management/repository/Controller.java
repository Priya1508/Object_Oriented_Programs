...
{ 
	...
	//TO READ FILE FROM APPOINTMENT FILE
	...
	public void writeFileAppointment(List<Appointment> appointment) throws IOException
	{
		mapper.defaultPrettyPrintingWriter().writeValue(fileAppointment, appointment);
	}
}
